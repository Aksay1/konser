...
<div class="single-widget">
    ...
    <div class="content">
        <?php
        // Harga kategori tiket yang dipilih (contoh)
        $selectedTicketPrice = 100000; // Default harga Silver
        
        // Mengecek apakah ada input dari pengguna (misalnya melalui form POST)
        if (isset($_POST['ticketCategory'])) {
            $selectedTicketPrice = (int)$_POST['ticketCategory'];
        }
        ...
        // Menghitung total
        $total = $selectedTicketPrice + $shipping;
        ?>

        <ul>
            <li>Sub Total<span>IDR <?php echo number_format($selectedTicketPrice, 0, ',', '.'); ?>K</span></li>
            <li>(+) Shipping<span>IDR <?php echo number_format($shipping, 0, ',', '.'); ?>K</span></li>
            <li class="last">Total<span>IDR <?php echo number_format($total, 0, ',', '.'); ?>K</span></li>
        </ul>
    </div>
</div>
<!--/ End Order Widget -->
